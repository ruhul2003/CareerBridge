            ...
            <div className="max-w-6xl mx-auto">
                ...
                <div className="flex justify-center mb-16">
                    <div className="p-1.5 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl flex items-center gap-1 shadow-md">
                        <button
                            ...
                            className={`flex items-center gap-2 px-5 py-2 text-sm font-medium rounded-lg transition-all duration-200 cursor-pointer ${billingTarget === 'seeker'
                        ...
                        <button
                            ...
                            className={`flex items-center gap-2 px-5 py-2 text-sm font-medium rounded-lg transition-all duration-200 cursor-pointer ${billingTarget === 'recruiter'
                                ? 'bg-zinc-900 dark:bg-zinc-800 text-white shadow-md border border-zinc-800 dark:border-zinc-700/50'
                                : 'text-zinc-600 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-zinc-200'
                                }`}
                        >
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-start mb-24">
                    {activePlans.map((plan, idx) => (
                        <div
                            key={idx}
                            className={`relative bg-white dark:bg-zinc-900 border rounded-2xl p-6 shadow-xl shadow-slate-200/80 dark:shadow-2xl dark:shadow-black/80 flex flex-col justify-between min-h-[480px] transition-all duration-300 hover:-translate-y-1.5 hover:shadow-blue-500/15 ${plan.popular
                        ...
                        {faqs.map((faq, idx) => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div
                                        className={`transition-all duration-300 ease-in-out overflow-hidden ${isOpen ? 'max-h-40 border-t border-zinc-200 dark:border-zinc-800/60' : 'max-h-0'
                                            }`}
                                    >
